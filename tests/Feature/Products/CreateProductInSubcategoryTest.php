...
class CreateProductInSubcategoryTest extends TestCase
{
    use RefreshDatabase;
     ...
     * @test
     */
    public function a_product_can_be_created_in_a_subcategory()
    {
        $this->disableExceptionHandling();

        $subcategory = factory(Subcategory::class)->create();

        $response = $this->asLoggedInUser()->json("POST", "/admin/subcategories/{$subcategory->id}/products", [
            'title'       => 'TEST TITLE',
            'code'        => 'TEST CODE',
        ...
        $this->assertDatabaseHas('stockables', [
            ...
            'stockable_id'   => $subcategory->id,
            'stockable_type' => Subcategory::class
        ]);
    }
     ...
     * @test
     */
    public function a_newly_created_product_in_a_subcategory_has_a_slug()
    {
        $this->disableExceptionHandling();
