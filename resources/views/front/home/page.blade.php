...
@section('content')
    ...
    <section class="col-d-bg pv6">
        ...
        <p class="f3 col-w tc measure-wide body-type center">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                             Accusantium asperiores debitis deserunt ducimus excepturi
                                                             itaque iure minus officia optio, quod quos ratione sit
                                                             suscipit tempora unde? Dolore laborum molestias nam!</p>
        <a href="#"
    ...
    <section class="col-d-bg pv6">
        ...
        <p class="f3 col-w tc measure-wide body-type center">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                             ...
                                                             suscipit tempora unde? Dolore laborum molestias nam!</p>
        <a href="#"
           class="col-p f3 center db strong-type mt4 link tc flex items-center justify-center ttu">Find a
                                                                                                   store @include('svgicons.button-arrow', ['classes' => 'ml3 ih3'])</a>
    </section>
    <section class="col-lg-bg pv6">
        ...
        <a href="#"
           class="col-d f3 center db strong-type mt4 link tc flex items-center justify-center ttu">More
                                                                                                   News @include('svgicons.button-arrow', ['classes' => 'ml3 ih3 icon-d'])</a>
    </section>
@endsection